...
#define SYSCALL_DRAWSTRING 16
#define SYSCALL_DRAWSTRINGLN 17
#define SYSCALL_GETSTRING 18
#define SYSCALL_DRAWLINE 19
#define SYSCALL_CHANGECOLOR 20
...
unsigned long long internal_getstring(unsigned int a0, unsigned int a1,
	unsigned int a2, unsigned int a3, unsigned int a4);
unsigned long long internal_drawline(unsigned int a0, unsigned int a1,
	unsigned int a2, unsigned int a3, unsigned int a4);
unsigned long long internal_changeTextColor(unsigned int a0, unsigned int a1,
	unsigned int a2, unsigned int a3, unsigned int a4);
